...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\eduar\Desktop\Projeção\projeto web\App\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\eduar\Desktop\Projeção\projeto web\App\venv\Scripts\deactivate.nu'
